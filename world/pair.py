...
TONIC = (lambda t_: apply_tonic(REG, M, t_, 1.0 / fps, skip=TONIC_SKIP + ("UV_", "R7_", "R8_")))   # the standing brain: floor, command, thermal cells at 25 C (09-18)
def TONIC_STAND(t_):   # standing = the floor without the walking command (10:31: with it, the pace reference rose with the dose; 10:55: the cells kept their drive when the row was skipped)
    apply_tonic(REG, M, t_, 1.0 / fps, skip=TONIC_SKIP + ("walk_", "UV_", "R7_", "R8_"))
